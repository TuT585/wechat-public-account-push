...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxa196c5892a6eef66',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '38199039359fbf68f122215845f33a13',
  ...
  USERS: [
    {
      ...
      id: 'oblZF6hDZxVSP1iQCc2MSGWkK03Q',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '3Omp7QIzviZoJyePzfstAMI2OocnfjE4ZNjrqxblPtM',
      // 所在省份
      province: '北京',
      // 所在城市
      city: '北京',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '老婆', year: '1996', date: '03-22',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2021', date: '03-20',
        }
      ],
